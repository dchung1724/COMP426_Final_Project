let axios,strict,checkServerIdentity;_751‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_751‍.w("assert",[["strict",["strict"],function(v){strict=v}]]);_751‍.w("tls",[["checkServerIdentity",["checkServerIdentity"],function(v){checkServerIdentity=v}]]);
...
let logging_in = go_login(username, password).then(async function(result) {
    ...
    _751‍.g.console.log(getting_response.data.result);
